...
var MatomoTracker = /** @class */ (function () {
    ...
    function (customTitle) {
        try {
            ...
            window._paq.push(tslib_1.__spread(['trackPageView'], args));
        }
        catch (e) {
            if (!(e instanceof ReferenceError)) {
                throw e;
    ...
    function (category, action, name, value) {
        try {
            ...
            window._paq.push(tslib_1.__spread(['trackEvent'], args));
        }
        catch (e) {
            if (!(e instanceof ReferenceError)) {
                throw e;
    ...
    function (keyword, category, resultsCount) {
        try {
            ...
            window._paq.push(tslib_1.__spread(['trackSiteSearch'], args));
        }
        catch (e) {
            if (!(e instanceof ReferenceError)) {
                throw e;
    ...
    function (idGoal, customRevenue) {
        try {
            ...
            window._paq.push(tslib_1.__spread(['trackGoal'], args));
        }
        catch (e) {
            if (!(e instanceof ReferenceError)) {
                throw e;
    ...
    function (productSKU, productName, productCategory, price, quantity) {
        try {
            ...
            window._paq.push(tslib_1.__spread(['addEcommerceItem'], args));
        }
        catch (e) {
            if (!(e instanceof ReferenceError)) {
                throw e;
    ...
    function (orderId, grandTotal, subTotal, tax, shipping, discount) {
        try {
            ...
            window._paq.push(tslib_1.__spread(['trackEcommerceOrder'], args));
        }
        catch (e) {
            if (!(e instanceof ReferenceError)) {
                throw e;
